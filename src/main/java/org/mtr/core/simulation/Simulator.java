...
public class Simulator extends Data implements Utilities {
	...
	/**
	 * Simulates the system in one-second intervals until the simulation is caught up, subject to a
	 * bounded work budget. If simulation work itself is slower than wall clock, skip the remaining
	 * elapsed time instead of trapping the scheduler in an unbounded catch-up loop.
	 *
